      ...
      <div>
          ...
          <div class="grid grid-cols-2 gap-x-4 gap-y-3">
              <div class="col-span-2">
                  ...
                  <input :value="fullname" class="block bg-slate-100 rounded-lg w-full px-3 py-2" type="text" :readonly="true" id="">
              </div>
              <div>
                  <label for="" class="">Telefono</label>
                  <input :value="cliente?.telefono" class="block bg-slate-100 rounded-lg w-full px-3 py-2" type="text" :readonly="true" id="">
              </div>
              <div>
                  <label for="" class="">Dirección</label>
                  <input :value="cliente?.direccion" class="block bg-slate-100 rounded-lg w-full px-3 py-2" type="text" :readonly="true" id="">
              </div>
      ...
      <div>
          ...
          <table class="w-full">
              ...
              <tbody>
                  <tr v-for="item in solicitudes" :key="item.id">
                      <td class="pr-3 py-2">
                          <input class="block bg-slate-100 rounded-lg w-full px-3 py-2" :value="item.servicioLaboratorio?.descripcion" type="text" name="" id="">
                      </td>
                      <td class="pr-3 py-2">
                          <input class="block bg-slate-100 rounded-lg w-full px-3 py-2" :value="item.paciente.persona.nombre" type="text" name="" id="">
                      </td>
                      <td class="pr-3 py-2">
                          <input class="block bg-slate-100 rounded-lg w-full px-3 py-2" :value="item.servicioLaboratorio?.precio" type="text" name="" id="">
                      </td>
                  </tr>
                  <tr>
                      <td></td>
                  ...
                  <tr>
                      ...
                      <td class="text-right px-3">
                          <div class="">- C${{ subtotal * descuentoTotal }}</div>
                      </td>
                  </tr>
                  <tr>
                      <td></td>
                      ...
                      <td class="text-right px-3">
                          <div class="">C${{ subtotal - (subtotal * descuentoTotal) }}</div>
                      </td>
                  </tr>
              </tbody>
          </table>
